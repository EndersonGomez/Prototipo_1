...
import com.example.ingresusuario2.Model.Local.UserDataDao
import com.example.ingresusuario2.Model.Local.UserEntity
import com.example.ingresusuario2.Model.Remote.RetrofitClient
...
class UserRepository (private val userDao: UserDataDao) {
    ...
    //Instanciamos una variable que lla a la funcion que trae la base de datos.
